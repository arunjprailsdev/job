...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { education: @bank.education, lastdate: @bank.lastdate, more: @bank.more, post: @bank.post, postdate: @bank.postdate } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { education: @bank.education, lastdate: @bank.lastdate, more: @bank.more, post: @bank.post, postdate: @bank.postdate } }
